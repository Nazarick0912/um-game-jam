...
func _physics_process(delta: float) -> void:
 ...
 # Update play time and calculate gradual intensity
 ...
 if play_time_passed > 30.0:
  # Gradually increase between 30s and 60s (0.0 to 1.0 progress)
 ...
 # Update TimeEdit text and check win/lose condition
 var time_left = max(60.0 - play_time_passed, 0.0)
 if timer_text_edit:
